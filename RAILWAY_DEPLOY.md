...
Prieš eksperimentą dalyvis pateikia amžiaus grupę, lytį, išsilavinimą, veiklos sritį, patirtį su duomenų vizualizacijomis, diagramų analizavimo dažnį ir duomenų analizės patirtį. Duomenys saugomi `participant_sessions` lentelėje ir eksportuojami CSV.
